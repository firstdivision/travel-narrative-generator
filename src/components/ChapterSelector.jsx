...
export function ChapterSelector({ chapters, currentSlug, isGalleryRoute, loading, onJumpToChapter }) {
  ...
  return (
    <div className="chapter-dropdown" ref={dropdownRef}>
      <button
        ref={buttonRef}
        className={`chapter-dropdown-button${!isGalleryRoute ? " is-active" : ""}`}
      ...
      >
        <span className="chapter-dropdown-prefix">Read Journal</span>
        <span className="chapter-dropdown-divider" aria-hidden="true">
          /
        </span>
